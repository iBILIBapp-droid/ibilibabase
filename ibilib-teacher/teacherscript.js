...
function openAdmin() {
    ...
    // Server-grade authorization: use the actual Supabase JWT Role!
    // Never use a hardcoded password.
    if (_userRole === 'teacher' || _userRole === 'private') {
        openAdminPanel();
    } else {
        alert("🔒 Unauthorized. You must be a teacher or admin to access this panel.");
    }
}
